...
Rectangle {
    ...
    Text {
        ...
        text: root.dayNumber
        color: root.inVisibleMonth ? (root.weekend ? "#aaa7ad" : "#f2f0f5") : "#5a585f"
    ...
    ToolTip.visible: pointer.containsMouse && (pendingCount + completedCount) > 0
    ToolTip.text: pendingCount + " pendente" + (pendingCount === 1 ? "" : "s") + (completedCount > 0 ? " · " + completedCount + " concluída" + (completedCount === 1 ? "" : "s") : "")
    ToolTip.delay: 350
